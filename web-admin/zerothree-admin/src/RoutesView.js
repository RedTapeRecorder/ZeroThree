...
const s = {
  ...
  content:          { flex: 1, display: 'flex', flexDirection: 'column', padding: '20px 24px', boxSizing: 'border-box', overflow: 'hidden' },

  header:           { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '8px', gap: '12px', flexWrap: 'wrap' },
  ...
  createBtn:        { padding: '8px 16px', background: '#f97316', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '13px', fontWeight: '600', cursor: 'pointer', whiteSpace: 'nowrap' },
  cancelBtn:        { padding: '8px 16px', background: '#fff', color: '#374151', border: '1px solid #e5e7eb', borderRadius: '8px', fontSize: '13px', fontWeight: '600', cursor: 'pointer' },
  ...
  filterBtn:        { padding: '6px 12px', fontSize: '12px', fontWeight: '600', border: 'none', background: '#fff', color: '#6b7280', cursor: 'pointer', borderRight: '1px solid #e5e7eb' },
  ...
  th:               { padding: '8px 12px', textAlign: 'left', fontWeight: '600', color: '#6b7280', background: '#f9fafb', borderBottom: '1px solid #e5e7eb', whiteSpace: 'nowrap', position: 'sticky', top: 0 },
  tr:               { borderBottom: '1px solid #f3f4f6' },
  td:               { padding: '8px 12px', color: '#111827', verticalAlign: 'middle' },
  editBtn:          { padding: '3px 10px', fontSize: '12px', fontWeight: '600', background: '#f3f4f6', border: '1px solid #e5e7eb', borderRadius: '5px', cursor: 'pointer', color: '#374151' },
  dupBtn:           { padding: '3px 8px', fontSize: '12px', fontWeight: '600', background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: '5px', cursor: 'pointer', color: '#1d4ed8' },
  delBtn:           { padding: '3px 8px', fontSize: '12px', fontWeight: '600', background: '#fef2f2', border: '1px solid #fecaca', borderRadius: '5px', cursor: 'pointer', color: '#b91c1c' },
  ...
  editLayout:       { display: 'flex', flex: 1, gap: '8px', overflow: 'hidden' },
  editMeta:         { width: '280px', minWidth: '220px', flexShrink: 0, background: '#fff', border: '1px solid #e5e7eb', borderRadius: '10px', padding: '14px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '10px' },
  ...
  gmapsBtn:         { display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 10px', background: '#fff', border: '1px solid #e5e7eb', borderRadius: '7px', fontSize: '12px', fontWeight: '600', color: '#374151', cursor: 'pointer', width: '100%', boxSizing: 'border-box' },
  ...
  editSequence:     { width: '320px', minWidth: '260px', flexShrink: 0, background: '#fff', border: '1px solid #e5e7eb', borderRadius: '10px', display: 'flex', flexDirection: 'column', overflow: 'hidden' },
  ...
  sequenceList:     { flex: 1, overflowY: 'auto', padding: '6px' },
  ...
  builderLayout:    { display: 'flex', flex: 1, gap: '8px', overflow: 'hidden' },
  ...
  configPane:       { width: '340px', minWidth: '280px', flexShrink: 0, background: '#fff', border: '1px solid #e5e7eb', borderRadius: '10px', display: 'flex', flexDirection: 'column', padding: '14px', gap: '16px', overflowY: 'auto' },
